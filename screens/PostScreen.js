...
// import {onRefresh} from 'frontend/screens/ProfileScreen.js';
...
const PostScreen = ({navigation}) => {
    ...
    async function pickImage (){
        ...
        if (!result.canceled){
            ...
            setFileType('image'); //use to render image on page - before user posts 
            setCancel(true);
            //upload image 
    ...
    //NOT IMPLEMENTED - not enough space to store videos
    ...
    async function uploadCaller(){
        // console.log(image, fileType, imageBio);
        if(!image){
    ...
    //save record of uploaded image to firestore - link user ids and images
    ...
    return (
        <View style={styles.container}>
            <View style={styles.imgBioContainer}>
                ...
                {/* {uploading   
                    ...
                    : <TouchableOpacity style={{backgroundColor: 'black', borderRadius: 30, alignSelf: 'center', marginTop: 30}} onPress={uploadCaller}>
                        <Text style={{textAlign: 'center', alignSelf: 'center', paddingHorizontal: 8, paddingVertical: 5, borderRadius: 40, fontSize: 15, color: 'white'}}>Upload</Text>
                    </TouchableOpacity>
                } */}
        ...
        >
           <Ionicons name='videocam' size={24} color="white"></Ionicons>
        </TouchableOpacity> */}
