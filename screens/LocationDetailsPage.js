...
const GOOGLE_PLACES_API_KEY = 'AIzaSyA5omBLbqPM7a2zFE5r4B7TXQAgJ4Q14l4';
...
const LocationDetailsPage = ({ route }) => {
  ...
  const checkFavorited = async (locationName) => {
    //get the favorited list of user from firebase
    //check if the name of the current location passed is in list
    //if it does then set isSaved to true, else false
      ...
      <ScrollView style={styles.scrollContainer} ref={scrollViewRef}>
       ...
       <View style={styles.statusIndicator}>
       {
        ...
        <View style={styles.locationInfoContainer}>
          ...
          { /*
                  <View style={styles.scrollDownIconContainer}>
            <FontAwesome5 name="chevron-down" size={24} color="#06B2BE" />
          </View>
                          */ }
