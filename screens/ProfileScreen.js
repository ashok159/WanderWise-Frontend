...
const ProfileScreen = ({navigation}) => {
                ...
                querySnapshot.forEach((doc) => {
                    if (doc.exists()) {
                        ...
                        postsData.push({
                            id: imageID,
                            ...imageData,
                            ConDate: convertedDate, // Replace the original date with the converted date
                          });
                    } else {
                        console.log("No such document!");
                    }
    ...
    const handleSaveBio = async () => {
        ...
        if (bio.trim() !== '') {
            ...
            setIsEditingBio(false); // Exit editing mode if bio is empty
        }
    };
          ...
          <ScrollView style={styles.container} contentContainerStyle={{ justifyContent: 'center', alignItems: 'center' }} showsVerticalScrollIndicator={false} refreshControl={
            ...
            <Modal visible={showLogoutConfirm} transparent>
                <View style={{justifyContent: 'center', alignItems: 'center', marginTop:'50%'}}>
                    ...
                    borderWidth:1, width:'85%', elevation: 5, // Android shadow
              ...
              <View style={styles.userInfoWrapper}>
                ...
                <Modal visible={showFollowings || showFollowers} transparent>
                    <View style={{justifyContent: 'center', alignItems: 'center', marginTop:'20%'}}>
                        ...
                        padding: 20, borderRadius: 10, elevation: 5, borderColor:'#ddd', 
                        borderWidth:1, width:'85%', height: '70%', elevation: 5, // Android shadow
                        shadowColor: '#000', // iOS shadow
                        shadowOffset: { width: 0, height: 2 },
                        shadowOpacity: 0.25,
                        shadowRadius: 3.84,}}>
                ...
                {/* <View style={styles.userInfoWrapper}>
                  <View style={{width:"100%"}}>
                    {
                        posts.map((item, index)=><UserPost key={index} userDataIn={item}></UserPost>)
                    }
                  </View>
                </View> */}
