...
const SearchUsers = () => {
  ...
  const renderUserProfile = () => {
     // if(userUID){
        //     return(
                // <>
                //     <OtherUserProfilePicture props={userUID}></OtherUserProfilePicture>
    ...
    <SafeAreaView key={refreshKey} style={{ backgroundColor: 'transparent', width: '90%' }}>
      <View style={styles.container} contentContainerStyle={{ justifyContent: 'center', alignItems: 'center' }} showsVerticalScrollIndicator={false}>
            {/* <View style={styles.searchUserContainer}>
                ...
                <Image source={require('frontend/assets/icons/multiple-users-silhouette.png')} resizeMode='contain' style={styles.groupImage}></Image>
            </View> */}
