...
function EventsToday() {
  ...
  const formatDate = (dateString) => {
    ...
    const formattedDate = new Date(dateString).toLocaleDateString(undefined, options)
      .replace(',', ''); // Remove the comma after the day of the week
      ...
      <View style={styles.container}>
        ...
        {isLoading ? (
         ...
         {/* 
          ...
          <TouchableOpacity style={styles.viewCalendarButton} onPress={handleViewCalendar}>
        <Text style={styles.buttonText}>View Calendar</Text>
      </TouchableOpacity> */}

      {/* <TouchableOpacity style={styles.viewCalendarButton} onPress={handleViewCalendar}>
        <Image source={require('frontend/assets/icons/schedule.png')} style={{ height: 35, width: 35 }}></Image>
      </TouchableOpacity> */}
      </View>
    </TouchableOpacity>
  );
